...
INSERT INTO "new_PrintJob" ("createdAt", "customerId", "deadline", "description", "format", "id", "material", "quantity", "status", "title", "updatedAt", "winnerProviderId") SELECT "createdAt", "customerId", "deadline", "description", "format", "id", "material", "quantity", "status", "title", "updatedAt", "winnerProviderId" FROM "PrintJob";
DROP TABLE "PrintJob";
